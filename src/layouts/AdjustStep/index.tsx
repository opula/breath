    ...
    <TrayScreen trayHeight={(isBreath ? 440 : 240) + bottom}>
      <View style={tw`pt-6 px-2 flex-1 items-center`}>
        ...
        {isBreath ? (
          <>
            <View
              style={tw`mt-4 flex-row items-center justify-center`}>
              <TouchableOpacity
                ...
                <Text
                  style={tw`text-center text-xs font-lusitana ${selectedPart === 0 ? 'text-blue-500' : 'text-white'}`}>{`Inhale (${
                  (value as number[])[0]
                }s)`}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <Text
                  style={tw`text-center text-xs font-lusitana ${selectedPart === 1 ? 'text-blue-500' : 'text-white'}`}>{`Hold (${
                  (value as number[])[1]
                }s)`}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <Text
                  style={tw`text-center text-xs font-lusitana ${selectedPart === 2 ? 'text-blue-500' : 'text-white'}`}>{`Exhale (${
                  (value as number[])[2]
                }s)`}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <Text
                  style={tw`text-center text-xs font-lusitana ${selectedPart === 3 ? 'text-blue-500' : 'text-white'}`}>{`Hold (${
                  (value as number[])[3]
                }s)`}</Text>
              </TouchableOpacity>
            </View>
