...
const tanhVec3 = Fn(([x]: [ReturnType<typeof vec3>]) => {
...
const terrainMatrix = Fn(([v]: [ReturnType<typeof vec2>]) => {
  return vec2(
...
const gradient4 = Fn(([tIn]: [ReturnType<typeof float>]) => {
  const t = fract(tIn);
